...
set_property PACKAGE_PIN E3 [get_ports clk]							
 ...
 ##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { PBC }]; #IO_L9P_T1_DQS_14 Sch=btnc
